...
1-2 sentences about the key takeaways HERE!!!!!!!! DONT FORGET TO WRITE THIS UP
...
2 - 3 SENTENCES COMPARING THE MEANS THAT PROVIDES MEANINGFUL DISCUSSION ABOUT THE MEAN DIFFERENCES BEYOND (but also including) THE PVALUE. INCLUDING ACTUAL MEANS AND STDEV FOR EACH GROUP AND ACTUAL DIFF AND/OR % DIFF IN MEANS

**Conclusion**

MEANING OF THE PVALUE THAT YOU FOUND IN THE T TEST
